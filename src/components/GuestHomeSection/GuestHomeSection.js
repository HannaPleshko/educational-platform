                    ...
                    <div className={main["learn-container"]}>
                        ...
                        <div className={main["learn-container-arrows"]}>
                            <div className={main["learn-flex_arrow"]}>
                                ...
                                <p>Learn the syntax of the JavaScript language, learn how to implement basic algorithmic<br />constructions on it.</p>
                            </div>
                            <div className={main["learn-flex_arrow"]}>
                                <div className={main["img_arrow"]}></div>
                            ...
                            <div className={main["learn-flex_arrow"]}>
                                <div className={main["img_arrow"]}></div>
                                <p>Learn how to write your own web applications with React,<br />learn how the Node.js software platform is designed to work with JavaScript on the server side.</p>
                            </div>
                            <div className={main["learn-flex_arrow"]}>
                                <div className={main["img_arrow"]}></div>
                            ...
                            <div className={main["learn-flex_arrow"]}>
                                <div className={main["img_arrow"]}></div>
                                <p>Learn to put your knowledge of HTML5/CSS3 into practice.<br />Get to know the new features of CSS3, master the animation of elements.</p>
                            </div>
                            <div className={main["learn-flex_arrow"]}>
                                <div className={main["img_arrow"]}></div>
                                <p>Learn version control tools Git, GitHub and be able to host and manage your own<br />site on GitHub Pages.</p>
                            </div>
                        </div>
            ...
            <section className={classNames(main["main-whywe"])}>
                <div className={classNames(main['mycontain'], main["container-whywe"])}>
                    <div className="">
                        ...
                        <p className={main["container-whywe--p1"]}>“I am a 35-year-old humanist who forgot school mathematics and instead of English studied German. Work takes all day and you have to travel on business trips. I have a family, a mortgage and two cats, and my friends say: "Why do you need this?" Not sure if I can…”</p>
                        <p className={main["container-whywe-p2"]}>We get asked questions like this every day. There is only one answer here: if you don’t try, you won’t understand. How does HS help you get started without losing anything?</p>
                    </div>
                ...
                <div className={classNames(main['mycontain'], main["container-reviews"])}>
                    ...
                    <div className={main["all_reviews"]}>
                        <div className={main["reviews"]}>
                            ...
                            <p className={main["container-reviews--p2"]}>I had some development experience before (backend) and I wanted to really learn JavaScript and I must tell you, this is the best JavaScript course on the internet period. It has everything you need to get you up to speed and more!!!</p>
                            <div className={main["img_star1"]}></div>
                        </div>
                        <div className={main["reviews"]}>
                            <div className={main["img_reviews"]}></div>
                            <p className={main["container-reviews--p1"]}>Maxim Novik</p>
                            <p className={main["container-reviews--p2"]}>I really learned a lot from Hanna. The way she teaches the course is really awesome and I recommonded to lot of friends and juniors regarding this course. Thank you for your wonderful course. I really appreciate your efforts that you put it on the course.</p>
                            <div className={main["img_star1"]}></div>
                        </div>
                        <div className={main["reviews"]}>
                            <div className={main["img_reviews"]}></div>
                            <p className={main["container-reviews--p1"]}>Nikita Skvortsov</p>
                            <p className={main["container-reviews--p2"]}>I am an Economic student with zero knowledge on programming and this course help me a lot to understand the basic and advanced part of JS. Students and teaching assissstant are pretty helpful too, there are alway an answer for some weird bugs you are dealt with.</p>
